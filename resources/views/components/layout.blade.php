  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a wire:navigate href="/" class="text-white">BlogChat</a></h4>

        @auth
        <div class="d-flex flex-row align-items-center my-3 my-md-0">
          ...
          <a wire:navigate href="/profile/{{auth()->user()->username}}" class="mr-2 d-inline-flex align-items-center" style="vertical-align: middle;"><img title="My Profile" data-toggle="tooltip" data-placement="bottom" style="width: 32px; height: 32px; border-radius: 16px; vertical-align: middle;" src="{{auth()->user()->avatar}}" /></a>
